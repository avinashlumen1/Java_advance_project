...
public class ProductOrderController {
  ...
  public String getProduct(Model model) {
   ...
   public String searchByProductMerchant(@RequestParam("merchant") String productMerchant, Model model) {
       model.addAttribute("list", this.template.postForObject("http://localhost:5050/byMerchant",productMerchant ,Product[].class));
       return "show-all";
   }
   ...
   public String searchById(@RequestParam("id") String id, Model model) {
       ...
       model.addAttribute("list", this.template.postForObject("http://localhost:5051/id",orderId ,Order[].class));
       return "order_list";
   }
